#!/usr/bin/env node
/**
 * Simple E2E Test for ClaudeLlmClient
 * Tests the Claude LLM endpoint with a simple haiku request
 *
 * Run with: node tests/e2e/claude-haiku.test.js
 */
...
console.log('🚀 Testing ClaudeLlmClient with Simple Haiku Request');
...
async function testClaudeHaiku() {
  try {
    console.log('📝 Requesting haiku from Claude...');
