#!/usr/bin/env node
/**
 * E2E Test for ClaudeLlmClient with MCP Tool Call
 * Tests Claude with get_dalive_content MCP tool call + haiku generation
 *
 * Run with: node tests/e2e/claude-mcp-get-test.js
 */
...
console.log('🚀 Testing ClaudeLlmClient with MCP Tool Call (get_dalive_content)');
...
async function testClaudeMcpGet() {
  try {
    console.log('📝 Requesting Claude to use MCP tool + write haiku...');
