 ...
 *
 * Run with: node tests/e2e/claude-mcp-streamable-get-test.js
 */
...
console.log('🚀 Testing MCP Streamable Endpoint with get_dalive_content tool');
...
async function testMcpStreamableGet() {
  try {
    ...
    const initResponse = await sendMcpRequest('initialize', {
      ...
      clientInfo: {
        name: 'claude-mcp-streamable-test',
        version: '1.0.0'
      }
    });
