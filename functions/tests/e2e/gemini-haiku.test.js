#!/usr/bin/env node
/**
 * Simple E2E Test for GeminiLlmClient
 * Tests the Gemini LLM endpoint with a simple haiku request
 *
 * Run with: node tests/e2e/gemini-haiku.test.js
 */
...
console.log('🚀 Testing GeminiLlmClient with Simple Haiku Request');
console.log(`   Server: ${FUNCTIONS_BASE_URL}`);
console.log(`   Date: ${dateStr}`);
console.log(`   Time: ${timeStr}`);
console.log('');

async function testGeminiHaiku() {
  try {
    console.log('📝 Requesting haiku from Gemini...');
