#!/usr/bin/env node
/**
 * Simple E2E Test for AzureAIFoundryLlmClient
 * Tests the Azure AI Foundry LLM endpoint with a simple haiku request
 *
 * Run with: node tests/e2e/azure-haiku.test.js
 */
...
console.log('🚀 Testing AzureAIFoundryLlmClient with Simple Haiku Request');
console.log(`   Server: ${FUNCTIONS_BASE_URL}`);
console.log(`   Date: ${dateStr}`);
console.log(`   Time: ${timeStr}`);
console.log('');

async function testAzureHaiku() {
  try {
    console.log('📝 Requesting haiku from Azure AI Foundry (GPT-4o Mini)...');
