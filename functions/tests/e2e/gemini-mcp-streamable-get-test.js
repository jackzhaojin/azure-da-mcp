 ...
 *
 * Run with: node tests/e2e/gemini-mcp-streamable-get-test.js
 */
...
console.log('🚀 Testing MCP Streamable Endpoint with get_dalive_content tool (Gemini variant)');
...
async function testMcpStreamableGet() {
  try {
    ...
    const initResponse = await sendMcpRequest('initialize', {
      ...
      clientInfo: {
        name: 'gemini-mcp-streamable-test',
        version: '1.0.0'
      }
    });
